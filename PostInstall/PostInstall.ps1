...
Function GetInstanceCredential {
    ...
    Try {
        $User = "Administrator"
        $PWord = ConvertTo-SecureString -String "Stellarstrike-Instance2000" -AsPlainText -Force
...
function download-resources {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/accelerated-dev/GPUUpdater/master/GPUUpdaterTool.ps1", "$env:APPDATA\ParsecLoader\GPUUpdaterTool.ps1")
