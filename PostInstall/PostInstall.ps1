...
function download-resources {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/accelerated-dev/GPUUpdater/master/GPUUpdaterTool.ps1?token=AKNDGDQJXDUBFESP4YG7APS7BTNMU", "$env:APPDATA\ParsecLoader\GPUUpdaterTool.ps1")
