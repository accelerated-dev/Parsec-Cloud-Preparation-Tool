...
function download-resources {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/accelerated-dev/GPUUpdater/master/GPUUpdaterTool.ps1?token=AKNDGDX6OQ7CATLPFJUFBJC7BTKV2", "$env:APPDATA\ParsecLoader\GPUUpdaterTool.ps1")
